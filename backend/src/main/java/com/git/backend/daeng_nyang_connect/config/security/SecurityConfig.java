                ...
                .authorizeHttpRequests((authorize) ->
                        authorize
                                ...
                                .requestMatchers("/api", "/api/signup", "api/IdCheck","api/NicknameCheck","/api/login","/api/logout", "api/findPassword","api/findId","api/myPage",
                                        ...
                                        "api/review/all", "api/review", "api/review/comment", "/swagger-ui/**", "/v3/api-docs/**","/naver_redirect", "/NaverRegister", "/kakao_redirect", "api/animal/adoptionStatus/**", "api/lost/search").permitAll()
